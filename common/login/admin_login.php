...
$s = "select * from admindata where admin_id = '$id' and password = '$pswd'";
...
if($num >= 1){
 ...
 header( "refresh:0;url=../../admin/admin_home/admin_home.php" );
...
<body>
    ...
    <nav>
     ...
     <div class="container">
    <div class="form">
        <form  name="form" method="post" action="admin_login.php" >
        ...
        <div class="input-wrapper">
            <div class="userid-label">Admin ID</div>
...
<!-- 
        ...
        <div class="faculty-reg-btn" style="display: flex;"  onclick="window.location.href='../../admin/admin_home/admin_home.php'">
...
<!--     <template class="forget-password-dialog">
