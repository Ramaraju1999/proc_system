...
$s = "insert into chat(frommsg,tomsg,msg,date) values('$msgfrom','admin','$msg','$date')";
...
if($rows['frommsg']==$regdNo and $rows['tomsg']=='admin')
{
...
<?php  } 
if($rows['frommsg']=='admin' and $rows['tomsg']==$regdNo){
?>
